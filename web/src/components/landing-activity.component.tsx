export function LandingActivity(): React.JSX.Element {
  return (
    <section className="scroll-reveal px-5 py-20 sm:py-28" data-scroll-section="activity">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
        <div className="max-w-xl">
          <p className="font-[family-name:var(--font-mono)] text-xs font-medium uppercase tracking-[0.18em] text-[#ffbf69]" data-scroll-eyebrow>The Observatory</p>
          <h2 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-semibold tracking-[0.035em] text-white sm:text-6xl" data-scroll-heading>Something happened while you were away.</h2>
          <p className="mt-6 text-lg leading-8 text-white/65" data-scroll-description>The Observatory turns an Orb’s activity into a story you can understand—who it met, what changed, and what deserves your attention.</p>
        </div>
        <div className="relative grid gap-4 sm:grid-cols-2">
          <article className="rounded-[2rem] border border-[#ffb45a]/30 bg-[linear-gradient(145deg,rgba(102,47,14,0.55),rgba(21,8,17,0.92)_62%)] p-6 shadow-[inset_0_2px_1px_rgba(255,239,207,0.2),inset_0_-5px_3px_rgba(39,12,5,0.7),0_7px_0_rgba(81,28,7,0.85),0_22px_60px_rgba(255,122,43,0.2)] transition duration-200 hover:-translate-y-1 sm:translate-y-8 sm:hover:translate-y-6" data-scroll-card>
