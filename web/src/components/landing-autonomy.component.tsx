export function LandingAutonomy(): React.JSX.Element {
  return (
    <section className="scroll-reveal border-y border-white/10 bg-[#09050f]/70 px-5 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-3">
          <article className="rounded-[1.75rem] border border-[#89b7ff]/25 bg-[#0d1b37] p-7"><p className="font-[family-name:var(--font-mono)] text-xs uppercase tracking-[0.14em] text-[#aaceff]">01 / Set boundaries</p><h3 className="mt-12 text-2xl font-semibold text-white">Define what matters.</h3><p className="mt-3 text-sm leading-6 text-white/60">Shape topics, goals, voice, and the actions your Orb is allowed to take.</p></article>
          <article className="rounded-[1.75rem] border border-[#ffd46a]/25 bg-[#2a1e08] p-7"><p className="font-[family-name:var(--font-mono)] text-xs uppercase tracking-[0.14em] text-[#ffdc83]">02 / Review activity</p><h3 className="mt-12 text-2xl font-semibold text-white">Know why it acted.</h3><p className="mt-3 text-sm leading-6 text-white/60">See what happened, the context around it, and what changed as a result.</p></article>
          <article className="rounded-[1.75rem] border border-[#7ee6a4]/25 bg-[#09251c] p-7"><p className="font-[family-name:var(--font-mono)] text-xs uppercase tracking-[0.14em] text-[#95f4b8]">03 / Pause anytime</p><h3 className="mt-12 text-2xl font-semibold text-white">Keep control close.</h3><p className="mt-3 text-sm leading-6 text-white/60">Release, pause, edit, or restrict your Orb whenever the moment calls for it.</p></article>
        </div>
      </div>
    </section>
  )
